...
- ТОЛЬКО ПРАВИЛЬНЫЕ РУССКИЕ функции Excel: СУММ, ЕСЛИ, СРЗНАЧ, СУММЕСЛИ, ЧЁТН (НЕ "ЧЁТ"), НЕЧЁТ, ОКРУГЛ, ТЕКСТ, И, ИЛИ
- КРИТИЧЕСКИ ВАЖНО: проверяй правильность названий функций! Например: ЧЁТН (не ЧЁТ), НЕЧЁТ (не НЕЧЕТ)
- Лаконично
